...
#define DWG_ERR_CRITICAL DWG_ERR_CLASSESNOTFOUND
  ...
  */
  ...
  /**
   CMC colors: color index or rgb value. layers are off when the index is
   negative. Used as \ref Dwg_Color
   */
  ...
  typedef struct _dwg_entity_TEXT
  {
    ...
    BITCODE_2DPOINT alignment_pt; /*!< DXF 11. optional, when dataflags & 2,
                                     i.e 72/73 != 0 */
    ...
    BITCODE_BS horiz_alignment;   /*!< DXF 72. options 0-5:
                                     ...
                                     4 = Middle; 5 = Fit */
    BITCODE_BS
        vert_alignment; /*!< DXF 73. options 0-3:
...
#define DIMENSION_COMMON                                                      \
  ...
  typedef struct _dwg_entity_SPLINE
  {
    ...
    BITCODE_BS degree;
    BITCODE_BL splineflags1; /* 2013+: method fit points = 1, CV frame show =
                                2, closed = 4 */
...
#define _3DSOLID_FIELDS                                                       \
  ...
  typedef struct _dwg_entity_MTEXT
  {
    ...
    BITCODE_BD linespace_factor; /*!< DXF 44. r2000+. Mtext line spacing factor
                                  (optional): Percentage of default (3-on-5)
                                  line spacing to be applied. Valid values
  ...
  typedef struct _dwg_entity_LEADER
  {
    ...
    BITCODE_BS
        annot_type; /*< DXF(73) 0: text, 1: tol, 2: insert, 3 (def): none */
    ...
    BITCODE_H associated_annotation; /* DXF 340 Hard reference to associated
                                        annotation (mtext, tolerance, or insert
                                        entity) */
    BITCODE_H dimstyle;
  } Dwg_Entity_LEADER;
...
#define COMMON_TABLE_CONTROL_FIELDS(entries)                                  \
  ...
  typedef struct _dwg_LEADER_Line // as documented by DXF
  {
    ...
    /*!< r2010+: */
    BITCODE_BS
        type; // 0 = invisible leader, 1 = straight leader, 2 = spline leader
    BITCODE_CMC color;
    ...
    BITCODE_BL
        flags; // 1 = leader type, 2 = line color, 4 = line type, 8 = line
               // weight, 16 = arrow size, 32 = arrow symbol (handle)
  } Dwg_LEADER_Line;
  ...
  typedef struct _dwg_entity_TABLE
  {
    ...
    BITCODE_BS flag_for_table_value; /*!< DXF 90.
                                       Bit flags, 0x06 (0x02 + 0x04): has
                                       block, 0x10: table direction, 0 = up, 1
                                       = down, 0x20: title suppressed.
  ...
  */
  ...
  typedef struct _dwg_object_UNDERLAYDEFINITION
  {
    ...
    BITCODE_TV
        filename;    /*!< DXF 1, relative or absolute path to the image file */
  ...
  { /* dxf group code */
    ...
    BITCODE_BL
        scale_est; /* None = 1, User specified scale factor = 2,
  ...
  typedef struct _dwg_object_VISUALSTYLE
  {
    ...
    BITCODE_BS face_lighting_model;   /*!< DXF 71 0:Invisible 1:Visible 2:Phong
                                         3:Gooch */
    BITCODE_BS face_lighting_quality; /*!< DXF 72 0:No lighting 1:Per face
                                         2:Per vertex */
    ...
    BITCODE_BS
        face_modifier; /*!< DXF 90 0:No modifiers 1:Opacity 2:Specular */
    ...
    BITCODE_H ownerhandle;
    // BITCODE_H dictionary; /* (hard-pointer to DICTIONARY_VISUALSTYLE or
    // reverse?) */
  ...
  typedef struct _dwg_object_MATERIAL
  {
    ...
    BITCODE_BS
        ambient_color_flag; /*!< DXF 70 0 Use current color, 1 Override */
    BITCODE_BD ambient_color_factor; /*!< DXF 40 0.0 - 1.0 */
    BITCODE_CMC ambient_color;       /*!< DXF 90 */

    BITCODE_BS
        diffuse_color_flag; /*!< DXF 71 0 Use current color, 1 Override */
    ...
    BITCODE_BS diffusemap_projection;  /*!< DXF 73 1 Planar (def), 2 Box, 3
                                          Cylinder, 4 Sphere */
    ...
    BITCODE_BS
        specular_color_flag; /*!< DXF 76 0 Use current color, 1 Override */
    ...
    BITCODE_BS specularmap_projection;  /*!< DXF 78 1 Planar (def), 2 Box, 3
                                           Cylinder, 4 Sphere */
    BITCODE_BS specularmap_tiling; /*!< DXF 79 1 Tile (def), 2 Crop, 3 Clamp */
    BITCODE_BS
        specularmap_autotransform; /*!< DXF 170 1 no, 2: scale to curr ent,
                                                4: w/ current block transform
                                    */
    ...
    BITCODE_BS
        reflectionmap_source; /*!< DXF 171 0 current, 1 image file (default) */
    BITCODE_T
        reflectionmap_filename; /*!< DXF 6 if NULL no reflectionmap map */
    BITCODE_BD reflectionmap_blendfactor; /*!< DXF 48 1.0 */
    BITCODE_BS reflectionmap_projection;  /*!< DXF 172 1 Planar (def), 2 Box, 3
                                             Cylinder, 4 = Sphere */
    BITCODE_BS
        reflectionmap_tiling; /*!< DXF 173 1 Tile (def), 2 Crop, 3 Clamp */
    BITCODE_BS reflectionmap_autotransform;
        /*!< DXF 174 */                    // 1 no, 2: scale to curr ent,
                                           // 4: w/ current block transform
    ...
    BITCODE_T
        bumpmap_filename; /*!< DXF 8 if NULL no bumpmap (called asset_name) */
    BITCODE_BD bumpmap_blendfactor; /*!< DXF 143 def: 1.0 */
    BITCODE_BS bumpmap_projection;  /*!< DXF 270 1 Planar (def), 2 Box, 3
                                       Cylinder, 4 Sphere */
    BITCODE_BS bumpmap_tiling; /*!< DXF 271 1 Tile (def), 2 Crop, 3 Clamp */
    BITCODE_BS bumpmap_autotransform;
        /*!< DXF 272 */              // 1 no, 2: scale to curr ent,
                                     // 4: w/ current block transform
    ...
    BITCODE_BS
        refractionmap_source; /*!< DXF 273 0 current, 1 image file (def) */
    BITCODE_T refractionmap_filename; /*!< DXF 9 if NULL no refractionmap */
    BITCODE_BD refractionmap_blendfactor; /*!< DXF 146 def: 1.0 */
    BITCODE_BS refractionmap_projection;  /*!< DXF 274 1 Planar (def), 2 Box, 3
                                             Cylinder, 4 Sphere */
    BITCODE_BS
        refractionmap_tiling; /*!< DXF 275 1 Tile (def), 2 Crop, 3 Clamp */
    BITCODE_BS refractionmap_autotransform;
        /*!< DXF 276 */                    // 1 no, 2: scale to curr ent,
                                           // 4: w/ current block transform
    ...
    BITCODE_BS
        normalmap_source; /*!< DXF 72 0 current, 1 image file (default) */
    BITCODE_T normalmap_filename;     /*!< DXF 3 if NULL no normal map */
    BITCODE_BD normalmap_blendfactor; /*!< DXF 42 def: 1.0 */
    BITCODE_BS normalmap_projection; /*!< DXF 73 1 = Planar (def), 2 = Box, 3 =
                                        Cylinder, 4 = Sphere */
    BITCODE_BS
        normalmap_tiling; /*!< DXF 74 1 = Tile (def), 2 = Crop, 3 = Clamp */
    BITCODE_BS
        normalmap_autotransform;       /*!< DXF 75 1 no, 2: scale to curr ent,
                                                   4: w/ current block transform */
  ...
  typedef struct _dwg_object_PLOTSETTINGS
  {
    ...
    BITCODE_BS
        std_scale_type;          /*!< DXF 75, 0 = scaled to fit,
                                    ...
                                    21= 1:16          22 = 1:20, 23 = 1:30, 24 = 1:40, 25 = 1:50,
                                    26 = 1:100          27 = 2:1, 28 = 4:1, 29 = 8:1, 30 = 10:1,
                                    31 = 100:1, 32 = 1000:1
                                   */
    BITCODE_BD std_scale_factor; /*!< DXF 147, value of 75 */
    BITCODE_BS shade_plot_mode;  /*!< DXF 76, 0 display, 1 wireframe, 2 hidden,
                                    3 rendered,  4 visualstyle, 5 renderPreset */
    BITCODE_BS shade_plot_res_level;  /*!< DXF 77, 0 draft, 1 preview, 2 nomal,
                                                   3 presentation, 4 maximum, 5
                                         custom */
  ...
  typedef struct _dwg_entity_LIGHT
  {
    ...
    BITCODE_BD
        falloff_angle; /*!< DXF 51, always stored, used with type=spot only */
    ...
    BITCODE_B has_target_grip;     /*!< if the light displays a target grip for
                                      orienting     the light */
  ...
  */
  typedef struct _dwg_entity_EXTRUDEDSURFACE
  {
    ...
    BITCODE_BS sweep_alignment_flags;                   /*!< DXF 290.
                                                          ...
                                                          path,                   2=Translate sweep entity to path,
  ...
  */
  ...
  typedef struct _dwg_object_ASSOCOSNAPPOINTREFACTIONPARAM
  {
    ...
    BITCODE_B unknown1; //
    BITCODE_BS status;  // 90: 0 uptodate, 1 changed_directly, 2
                       // changed_transitive, 3 ChangedNoDifference, 4
                       // FailedToEvaluate, 5 Erased, 6 Suppressed 7 Unresolved
    BITCODE_T name;   // 1 ""
...
#pragma pack()
  ...
  /**
   General DWG object with link to either entity or object, and as parent the
   DWG
   */
  typedef struct _dwg_object
  {
    ...
    unsigned long common_size; /* the relative offset from type ... end
                                  common_entity_data */
    int handle_offset;
    int string_offset;
  ...
  typedef struct _dwg_class
  {
    ...
    BITCODE_BS
        item_class_id; /* Is-an-entity. 1f2 for entities, 1f3 for objects */
  ...
  /**
   Dwg_Chain similar to Bit_Chain in "bits.h". Used only for the Thumbnail
   picture
   */
  ...
  typedef struct _dwg_struct
  {
    ...
    BITCODE_BL
        num_object_refs; /*!< number of object_ref's (resolved handles) */
    Dwg_Object_Ref **object_ref; /*!< array of all handles */
    struct _inthash *object_map; /*!< map of all handles */
    int dirty_refs; /* 1 if we added an entity, and invalidated all the
                       internal ref->obj's */
  ...
  EXPORT unsigned char *dwg_bmp (const Dwg_Data *restrict,
                                 BITCODE_RL *restrict);
  ...
  EXPORT Dwg_Section_Type dwg_section_type (const DWGCHAR *wname);

  /** Free the whole DWG. all tables, sections, objects, ...
   */
  EXPORT void dwg_free (Dwg_Data *dwg);

  /** Free the object (all three structs and its fields)
   */
  EXPORT void dwg_free_object (Dwg_Object *obj);
